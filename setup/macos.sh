...
defaults write NSGlobalDomain AppleLocale -string "no@currency=NOK"
...
cp -r ../other/spectacle.json ~/Library/Application\ Support/Spectacle/Shortcuts.json 2> /dev/null
